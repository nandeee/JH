...
<%  for (fieldId in fields) {
        ...
        if (fields[fieldId].fieldType == 'Integer' || fields[fieldId].fieldType == 'Long' || fields[fieldId].fieldType == 'BigDecimal') {
            ...
            fieldInputType = 'checkbox';
                ...
                editableCellTemplate: '<div> <form name="inputForm"> <input type="<%= fieldInputType %>" <%= rulesArray.join(' ') %> ng-class="\'colt\' + col.uid" ui-grid-editor ng-model="MODEL_COL_FIELD" /> </form></div>'
<%  } %>
